%our method
sum_f_seq_var_01_level_2_MOGD = load('./levels=2(default)/var=0.01(default)/sum_f_seq.txt','-ascii');
time_seq_var_01_level_2_MOGD =  load('./levels=2(default)/var=0.01(default)/time_seq.txt','-ascii');
